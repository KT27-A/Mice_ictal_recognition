...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            # Read video
            self.mode = 'video'
            self.cap.set(cv2.CAP_PROP_POS_FRAMES, 1+self.frame)
...
def letterbox(img, new_shape=(640, 640), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True):
    print("Img shape before letterbox is {}.".format(img.shape))
    ...
    print("Img shape after letterbox is {}.".format(img.shape))
